# The 14-alpha pack: per-family logic truth-tables + full-pack wiring (15 alphas, 451 obs).
...
def test_alpha_pack_wiring_and_451():
    ...
    o, _ = env.reset()
    assert o.shape == (451,) and np.all(np.isfinite(o))
