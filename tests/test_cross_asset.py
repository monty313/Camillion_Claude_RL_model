# v1.6.0 CROSS-ASSET perception block: asset-class one-hot (covers the FULL FTMO broker via a
...
def test_block_in_contract_v1_4_0():
    assert C.OBSERVATION_CONTRACT_VERSION == "v1.6.0" and C.OBS_TOTAL_SIZE == 499
