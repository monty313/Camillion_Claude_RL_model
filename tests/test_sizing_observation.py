# v1.3.0 SIZING observation block (10 floats, ALL fractions of INITIAL balance): a 0.01..4-lot
...
def test_sizing_block_is_in_contract():
    assert C.OBS_BLOCK_SIZING == 10 and C.OBSERVATION_CONTRACT_VERSION == "v1.3.0"
