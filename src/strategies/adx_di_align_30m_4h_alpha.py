...
# WHY  ADX-DI Alignment (30m & 4h). Reads the ADX/DMI directional lines +DI and -DI
#      for periods 14 AND 45 on BOTH the 30m and 4h timeframes (4 DI pairs). Fires
...
# WHERE src/strategies/adx_di_align_30m_4h_alpha.py
...
# =====================================================================
"""ADX-DI Alignment (30m & 4h): -DI vs +DI agreement across periods 14&45 on both TFs."""
...
class AdxDiAlign30m4hAlpha(BaseStrategy):
    name = "adx_di_align_30m_4h"
    TIMEFRAMES = _TFS
    PERIODS = _PERIODS
