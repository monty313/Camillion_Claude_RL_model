...
# WHY  Regime Pulse Tracker (trend, 5m/30m: 30m gravity, 5m trigger).  Higher TF = gravity, lower TF = trigger. Output +1/-1/0 only;
#      pure function of the current ctx (no state, no future data).
# WHERE src/strategies/regime_pulse_trend_5m_30m_alpha.py
# DEPENDS_ON src/strategies/base.py, src/strategies/context.py
# =====================================================================
"""Regime Pulse Tracker (trend, 5m/30m: 30m gravity, 5m trigger)."""
from __future__ import annotations
import math
from src.strategies.base import BaseStrategy


class RegimePulseTrend5m30mAlpha(BaseStrategy):
    name = "regime_pulse_trend_5m_30m"
