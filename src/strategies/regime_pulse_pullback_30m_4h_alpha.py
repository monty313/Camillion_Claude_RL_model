...
# WHY  Regime Pulse Tracker (pullback, 30m/4h: 4h gravity, 30m trigger).  Higher TF = gravity, lower TF = trigger. Output +1/-1/0 only;
#      pure function of the current ctx (no state, no future data).
# WHERE src/strategies/regime_pulse_pullback_30m_4h_alpha.py
# DEPENDS_ON src/strategies/base.py, src/strategies/context.py
# =====================================================================
"""Regime Pulse Tracker (pullback, 30m/4h: 4h gravity, 30m trigger)."""
from __future__ import annotations
import math
from src.strategies.base import BaseStrategy


class RegimePulsePullback30m4hAlpha(BaseStrategy):
    name = "regime_pulse_pullback_30m_4h"
